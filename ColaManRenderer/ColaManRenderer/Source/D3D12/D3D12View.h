...
{
public:
    CD3D12ShaderResourceView(CD3D12Device* device,const D3D12_SHADER_RESOURCE_VIEW_DESC& desc,ID3D12Resource* resource);

    virtual ~CD3D12ShaderResourceView();
...
public:
    ...
    virtual ~CD3D12RenderTargetView();
...
public:
    ...
    virtual ~CD3D12DepthStencilView();
...
{
public:
    CD3D12UnorderedAccessView(CD3D12Device* device,const D3D12_UNORDERED_ACCESS_VIEW_DESC& desc,ID3D12Resource* resource);

    virtual ~CD3D12UnorderedAccessView();
