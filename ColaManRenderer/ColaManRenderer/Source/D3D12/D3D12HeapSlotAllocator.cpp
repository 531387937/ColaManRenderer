...
CD3D12HeapSlotAllocator::CD3D12HeapSlotAllocator(ID3D12Device* InDevice, D3D12_DESCRIPTOR_HEAP_TYPE Type, uint32_t NumDescriptorsPerHeap)
	:D3DDevice(InDevice),
...
// Create a non-shader-visible descriptor heap
D3D12_DESCRIPTOR_HEAP_DESC CD3D12HeapSlotAllocator::CreateHeapDesc(D3D12_DESCRIPTOR_HEAP_TYPE Type, uint32_t NumDescriptorsPerHeap)
{
...
void CD3D12HeapSlotAllocator::AllocateHeap()
{
	...
	SetDebugName(Heap.Get(), L"CD3D12HeapSlotAllocator Descriptor Heap");
