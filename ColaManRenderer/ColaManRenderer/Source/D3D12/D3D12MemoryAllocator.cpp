...
CD3D12BuddyAllocator::CD3D12BuddyAllocator(ID3D12Device* InDevice, const SAllocatorInitData& InInitData)
...
CD3D12MultiBuddyAllocator::CD3D12MultiBuddyAllocator(ID3D12Device* InDevice, const CD3D12BuddyAllocator::SAllocatorInitData& InInitData)
...
bool CD3D12MultiBuddyAllocator::AllocResource(uint32_t Size, uint32_t Alignment, CD3D12ResourceLocation& ResourceLocation)
{
...
{
	CD3D12BuddyAllocator::SAllocatorInitData InitData;
...
void* TD3D12UploadBufferAllocator::AllocUploadResource(uint32_t Size, uint32_t Alignment, CD3D12ResourceLocation& ResourceLocation)
{
...
void TD3D12DefaultBufferAllocator::AllocDefaultResource(const D3D12_RESOURCE_DESC& ResourceDesc, uint32_t Alignment, CD3D12ResourceLocation& ResourceLocation)
{
...
void CD3D3TextureResourceAllocator::AllocTextureResource(const D3D12_RESOURCE_STATES& ResourceState, const D3D12_RESOURCE_DESC& ResourceDesc, CD3D12ResourceLocation& ResourceLocation)
{
	...
	// Create placed resource
	{
		...
		CD3D12Resource* NewResource = new CD3D12Resource(Resource);
