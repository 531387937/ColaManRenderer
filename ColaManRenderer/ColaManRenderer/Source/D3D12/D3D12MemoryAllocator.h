...
public:
	CD3D12BuddyAllocator(ID3D12Device* InDevice, const SAllocatorInitData& InInitData);
...
{
public:
	CD3D12MultiBuddyAllocator(ID3D12Device* InDevice, const CD3D12BuddyAllocator::SAllocatorInitData& InInitData);
...
public:
	...
	void AllocDefaultResource(const D3D12_RESOURCE_DESC& ResourceDesc, uint32_t Alignment, CD3D12ResourceLocation& ResourceLocation);
...
public:
	...
	void AllocTextureResource(const D3D12_RESOURCE_STATES& ResourceState, const D3D12_RESOURCE_DESC& ResourceDesc, CD3D12ResourceLocation& ResourceLocation);
