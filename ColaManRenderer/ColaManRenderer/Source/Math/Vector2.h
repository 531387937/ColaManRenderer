...
struct SVector2 : public DirectX::XMFLOAT2
{
    ...
    SVector2(const XMFLOAT2& V) noexcept
    {
        this->x = V.x;
        this->y = V.y;
    }

    explicit SVector2(const DirectX::XMVECTORF32& F) noexcept
    {
        this->x = F.f[0];
        this->y = F.f[1];
    }
    ...
    SVector2& operator=(const DirectX::XMVECTORF32& F) noexcept
    {
        x = F.f[0];
        y = F.f[1];
        return *this;
    ...
    static void Barycentric(const SVector2& v1, const SVector2& v2, const SVector2& v3, float f, float g,
                            SVector2& result) noexcept;
    static SVector2 Barycentric(const SVector2& v1, const SVector2& v2, const SVector2& v3, float f, float g) noexcept;

    static void CatmullRom(const SVector2& v1, const SVector2& v2, const SVector2& v3, const SVector2& v4, float t,
                           SVector2& result) noexcept;
    static SVector2 CatmullRom(const SVector2& v1, const SVector2& v2, const SVector2& v3, const SVector2& v4,
                               float t) noexcept;

    static void Hermite(const SVector2& v1, const SVector2& t1, const SVector2& v2, const SVector2& t2, float t,
                        SVector2& result) noexcept;
    static SVector2 Hermite(const SVector2& v1, const SVector2& t1, const SVector2& v2, const SVector2& t2,
                            float t) noexcept;
...
inline void SVector2::Barycentric(const SVector2& v1, const SVector2& v2, const SVector2& v3, float f, float g,
                                  SVector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline SVector2 SVector2::Barycentric(const SVector2& v1, const SVector2& v2, const SVector2& v3, float f,
                                      float g) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline void SVector2::CatmullRom(const SVector2& v1, const SVector2& v2, const SVector2& v3, const SVector2& v4,
                                 float t, SVector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
    XMVECTOR x2 = XMLoadFloat2(&v2);
...
inline SVector2 SVector2::CatmullRom(const SVector2& v1, const SVector2& v2, const SVector2& v3, const SVector2& v4,
                                     float t) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline void SVector2::Hermite(const SVector2& v1, const SVector2& t1, const SVector2& v2, const SVector2& t2, float t,
                              SVector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline SVector2 SVector2::Hermite(const SVector2& v1, const SVector2& t1, const SVector2& v2, const SVector2& t2,
                                  float t) noexcept
{
    using namespace DirectX;
    XMVECTOR x1 = XMLoadFloat2(&v1);
...
inline void SVector2::Refract(const SVector2& ivec, const SVector2& nvec, float refractionIndex,
                              SVector2& result) noexcept
{
    using namespace DirectX;
    XMVECTOR i = XMLoadFloat2(&ivec);
