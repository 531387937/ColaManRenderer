...
struct SVector3 : public DirectX::XMFLOAT3
{
	...
	SVector3(const XMFLOAT3& V) noexcept { this->x = V.x; this->y = V.y; this->z = V.z; }
	explicit SVector3(const DirectX::XMVECTORF32& F) noexcept { this->x = F.f[0]; this->y = F.f[1]; this->z = F.f[2]; }
	...
	SVector3& operator= (const DirectX::XMVECTORF32& F) noexcept { x = F.f[0]; y = F.f[1]; z = F.f[2]; return *this; }
	...
	static void Barycentric(const SVector3& v1, const SVector3& v2, const SVector3& v3, float f, float g, SVector3& result) noexcept;
	static SVector3 Barycentric(const SVector3& v1, const SVector3& v2, const SVector3& v3, float f, float g) noexcept;

	static void CatmullRom(const SVector3& v1, const SVector3& v2, const SVector3& v3, const SVector3& v4, float t, SVector3& result) noexcept;
	static SVector3 CatmullRom(const SVector3& v1, const SVector3& v2, const SVector3& v3, const SVector3& v4, float t) noexcept;

	static void Hermite(const SVector3& v1, const SVector3& t1, const SVector3& v2, const SVector3& t2, float t, SVector3& result) noexcept;
	static SVector3 Hermite(const SVector3& v1, const SVector3& t1, const SVector3& v2, const SVector3& t2, float t) noexcept;
...
inline void SVector3::Barycentric(const SVector3& v1, const SVector3& v2, const SVector3& v3, float f, float g, SVector3& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
	XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline SVector3 SVector3::Barycentric(const SVector3& v1, const SVector3& v2, const SVector3& v3, float f, float g) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
	XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline void SVector3::CatmullRom(const SVector3& v1, const SVector3& v2, const SVector3& v3, const SVector3& v4, float t, SVector3& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
	XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline SVector3 SVector3::CatmullRom(const SVector3& v1, const SVector3& v2, const SVector3& v3, const SVector3& v4, float t) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
	XMVECTOR x2 = XMLoadFloat3(&v2);
...
inline void SVector3::Hermite(const SVector3& v1, const SVector3& t1, const SVector3& v2, const SVector3& t2, float t, SVector3& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
...
inline SVector3 SVector3::Hermite(const SVector3& v1, const SVector3& t1, const SVector3& v2, const SVector3& t2, float t) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat3(&v1);
	XMVECTOR x2 = XMLoadFloat3(&t1);
...
inline void SVector3::Refract(const SVector3& ivec, const SVector3& nvec, float refractionIndex, SVector3& result) noexcept
{
	using namespace DirectX;
	XMVECTOR i = XMLoadFloat3(&ivec);
	XMVECTOR n = XMLoadFloat3(&nvec);
