...
struct SVector4 : public DirectX::XMFLOAT4
{
	...
	SVector4(const XMFLOAT4& V) noexcept { this->x = V.x; this->y = V.y; this->z = V.z; this->w = V.w; }
	explicit SVector4(const DirectX::XMVECTORF32& F) noexcept { this->x = F.f[0]; this->y = F.f[1]; this->z = F.f[2]; this->w = F.f[3]; }
	...
	SVector4& operator= (const DirectX::XMVECTORF32& F) noexcept { x = F.f[0]; y = F.f[1]; z = F.f[2]; w = F.f[3]; return *this; }
	...
	static void Barycentric(const SVector4& v1, const SVector4& v2, const SVector4& v3, float f, float g, SVector4& result) noexcept;
	static SVector4 Barycentric(const SVector4& v1, const SVector4& v2, const SVector4& v3, float f, float g) noexcept;

	static void CatmullRom(const SVector4& v1, const SVector4& v2, const SVector4& v3, const SVector4& v4, float t, SVector4& result) noexcept;
	static SVector4 CatmullRom(const SVector4& v1, const SVector4& v2, const SVector4& v3, const SVector4& v4, float t) noexcept;

	static void Hermite(const SVector4& v1, const SVector4& t1, const SVector4& v2, const SVector4& t2, float t, SVector4& result) noexcept;
	static SVector4 Hermite(const SVector4& v1, const SVector4& t1, const SVector4& v2, const SVector4& t2, float t) noexcept;
...
inline void SVector4::Barycentric(const SVector4& v1, const SVector4& v2, const SVector4& v3, float f, float g, SVector4& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
	XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline SVector4 SVector4::Barycentric(const SVector4& v1, const SVector4& v2, const SVector4& v3, float f, float g) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
	XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline void SVector4::CatmullRom(const SVector4& v1, const SVector4& v2, const SVector4& v3, const SVector4& v4, float t, SVector4& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
	XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline SVector4 SVector4::CatmullRom(const SVector4& v1, const SVector4& v2, const SVector4& v3, const SVector4& v4, float t) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
	XMVECTOR x2 = XMLoadFloat4(&v2);
...
inline void SVector4::Hermite(const SVector4& v1, const SVector4& t1, const SVector4& v2, const SVector4& t2, float t, SVector4& result) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
...
inline SVector4 SVector4::Hermite(const SVector4& v1, const SVector4& t1, const SVector4& v2, const SVector4& t2, float t) noexcept
{
	using namespace DirectX;
	XMVECTOR x1 = XMLoadFloat4(&v1);
	XMVECTOR x2 = XMLoadFloat4(&t1);
...
inline void SVector4::Refract(const SVector4& ivec, const SVector4& nvec, float refractionIndex, SVector4& result) noexcept
{
	using namespace DirectX;
	XMVECTOR i = XMLoadFloat4(&ivec);
	XMVECTOR n = XMLoadFloat4(&nvec);
