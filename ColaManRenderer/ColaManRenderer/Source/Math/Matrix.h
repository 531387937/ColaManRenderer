...
struct SMatrix : public DirectX::XMFLOAT4X4
{
	...
	explicit SMatrix(const SVector4& r0, const SVector4& r1, const SVector4& r2, const SVector4& r3) noexcept
		: XMFLOAT4X4(r0.x, r0.y, r0.z, r0.w,
			...
			r2.x, r2.y, r2.z, r2.w,
			r3.x, r3.y, r3.z, r3.w) {}
	SMatrix(const DirectX::XMFLOAT4X4& M) noexcept { memcpy_s(this, sizeof(float) * 16, &M, sizeof(XMFLOAT4X4)); }
	...
	SMatrix(DirectX::CXMMATRIX M) noexcept { DirectX::XMStoreFloat4x4(this, M); }
	...
	void Up(const SVector3& v) noexcept { _21 = v.x; _22 = v.y; _23 = v.z; }

	SVector3 Down() const  noexcept { return SVector3(-_21, -_22, -_23); }
	void Down(const SVector3& v) noexcept { _21 = -v.x; _22 = -v.y; _23 = -v.z; }

	SVector3 Right() const noexcept { return SVector3(_11, _12, _13); }
	void Right(const SVector3& v) noexcept { _11 = v.x; _12 = v.y; _13 = v.z; }

	SVector3 Left() const noexcept { return SVector3(-_11, -_12, -_13); }
	void Left(const SVector3& v) noexcept { _11 = -v.x; _12 = -v.y; _13 = -v.z; }

	SVector3 Forward() const noexcept { return SVector3(-_31, -_32, -_33); }
	void Forward(const SVector3& v) noexcept { _31 = -v.x; _32 = -v.y; _33 = -v.z; }

	SVector3 Backward() const noexcept { return SVector3(_31, _32, _33); }
	void Backward(const SVector3& v) noexcept { _31 = v.x; _32 = v.y; _33 = v.z; }

	SVector3 Translation() const  noexcept { return SVector3(_41, _42, _43); }
	void Translation(const SVector3& v) noexcept { _41 = v.x; _42 = v.y; _43 = v.z; }
	...
	static SMatrix CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept;
	static SMatrix CreateOrthographic(float width, float height, float zNearPlane, float zFarPlane) noexcept;
	static SMatrix CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept;
...
inline SMatrix SMatrix::CreatePerspectiveFieldOfView(float fov, float aspectRatio, float nearPlane, float farPlane) noexcept
{
	using namespace DirectX;
	SMatrix R;
...
inline SMatrix SMatrix::CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlane, float farPlane) noexcept
{
	using namespace DirectX;
	SMatrix R;
...
inline SMatrix SMatrix::CreateOrthographicOffCenter(float left, float right, float bottom, float top, float zNearPlane, float zFarPlane) noexcept
{
	using namespace DirectX;
	SMatrix R;
